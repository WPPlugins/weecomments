...
function wee_javascripts()
{
	...
	<script type="text/javascript">
		...
		$("document").ready(function(){
			...
			$.ajax({type:"GET",url:"https://weecomments.com/es/webservice/show_product_v2?callback=lol&seo=0&id_shop='.$weecomments_options['WEE_ID_SHOP'].'&id_product='.get_the_ID().'", dataType: "jsonp",success: function(resp){$("#wee_prod").html(resp["widget"]);},error: function(e){}});
		});
	</script><script type="text/javascript" src="https://weecomments.com/js/widget-product.js"></script>
	';
}
